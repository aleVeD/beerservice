...
import guru.springframework.beerdemo.service.CustomerService;
...
public class CustomerController {
  ...
  public void handleUpdate(@Valid @RequestBody CustomerDto customerDto, @PathVariable("customerId") UUID customerId){
